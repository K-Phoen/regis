...
namespace Regis\GithubContext\Application\CommandHandler\Middleware;

use League\Tactician\Middleware;
use RulerZ\RulerZ;

use Regis\GithubContext\Application\Command\SecureCommandBySpecification;
use Regis\GithubContext\Application\Command\SecureCommand;
